...
export default {
  ...
  methods: {
    loadComments () {
      axios
        .get('https://blog-nuxt-b1552-default-rtdb.firebaseio.com/comments.json')
          .then((res)=>{
            let commentsArray = []
    ...
    changeComment (comment) {
      ...
      axios
        .put(`https://blog-nuxt-b1552-default-rtdb.firebaseio.com/comments/${comment.id}.json`, comment)
    },
    deleteComment (id) {
      axios
        .delete(`https://blog-nuxt-b1552-default-rtdb.firebaseio.com/comments/${id}.json`)
